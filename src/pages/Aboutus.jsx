...
const firstSectionContent = {
  sections: [
    ...
    },
    {
      heading: 'MOHIT',
      paragraphs: [
        "Mohit manages the Materials for the sites."
      ],
              ...
              <>
                ...
                >
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-gray-500 mb-8 tracking-wide">{section.specialty}</p>
                  </div>
                  <div className="space-y-5 text-sm text-gray-300 leading-relaxed">
                    {section.paragraphs.map((p, i) => (
                      <p key={i} className="group-hover:text-black transition-colors duration-500 text-black">{p}</p>
                    ))}
                  </div>
                ...
                >
                  ...
                  <div className="relative border-2 border-gray-300 p-1 w-96 h-[32rem] bg-white shadow-2xl">
                    <img
                      src={section.image}
                      alt="Portrait"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
          {firstSectionContent.sections.slice(2).map((section, index) => {
            ...
            return (
              ...
              >
                {/* Subtle hover glow */}
                <div className={`absolute inset-0 bg-gray-900/30 rounded-none blur-xl transform transition-all duration-700 ${
                  hoveredCard === index ? 'scale-110 opacity-100' : 'scale-100 opacity-0'
                }`}></div>
                
                <div className="relative bg-white border-2 border-gray-800 p-8 shadow-2xl transform transition-all duration-500 hover:scale-105 hover:border-gray-600">
                  {/* Profile image */}
                  ...
                  {/* Specialty */}
                  <p className="text-xs text-gray-500 text-center mb-6 tracking-wide">{section.specialty}</p>
                  ...
                  <div className="space-y-4 text-sm text-gray-300 leading-relaxed text-center">
                    {section.paragraphs.map((p, i) => (
                      <p key={i} className="group-hover:text-black transition-colors duration-500">{p}</p>
                    ))}
                  </div>
